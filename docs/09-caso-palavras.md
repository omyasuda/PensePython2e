...
Uma lista de palavras em Portugues pode ser obtida de https://www.ime.usp.br/~pf/dicios/br-utf8.txt Ao invés das palavras cruzadas temos jogo da Forca!

Estes arquivos estão em texto simples, então você pode abri-lo com um editor de texto, mas também pode lê-lo no Python. A função integrada open recebe o nome do arquivo como um parâmetro e retorna um objeto de arquivo que você pode usar para ler o arquivo.
